//============================================
//
//	上下に作用するとげ [MapNeedleUD.h]
//	Author:sakamoto kai
//
//============================================
#ifndef _MAPNEEDLEUD_H_
#define _MAPNEEDLEUD_H_
...
//オブジェクトプレイヤークラス
class CMapNeedleUD : public CObjectXtex
{
public:

	CMapNeedleUD(bool bChange, int nPriority = 0);
	~CMapNeedleUD();

	static CMapNeedleUD *Create(bool bChange);
