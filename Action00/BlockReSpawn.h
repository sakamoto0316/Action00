//============================================
//
//	復活時のブロック生成 [BlockSpawn.h]
//	Author:sakamoto kai
//
//============================================
#ifndef _BLOCKRESPAWN_H_
#define _BLOCKRESPAWN_H_
...
//オブジェクトプレイヤークラス
class CBlockReSpawn : public CObjectXtex
{
public:

	CBlockReSpawn(int nPriority = 3);
	~CBlockReSpawn();

	static CBlockReSpawn *Create();
